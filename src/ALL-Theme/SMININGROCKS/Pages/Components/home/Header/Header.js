      ...
      <div style={{
        ...
        <div style={{ display: 'flex', justifyContent: 'space-between', padding: '20px' }}>
          <div style={{ display: 'flex', margin: '5px', alignItems: 'center' }}>
            <MenuIcon style={{ fontSize: '40px', color: 'white' }} onClick={toggleDrawer(true)} />
          </div>
          <div style={{
            width: '33.33%',
            display: 'flex',
          ...
          <div style={{ width: '40px', display: 'flex', alignItems: 'center' }} onClick={() => navigation('/MobileSearch')}>
        ...
        <div div className={`Smining-Top-Header-fixed-main ${isHeaderFixed ? 'fixed' : ''}`}>
          <div className="Smining-Top-Header-fixed" style={{ display: 'flex', justifyContent: 'space-between' }}>
            <div style={{ display: 'flex', margin: '5px', alignItems: 'center' }}>
              <MenuIcon style={{ fontSize: '40px', color: '#7d7f85' }} onClick={openDrawer} />
            </div>
            <div style={{
              width: '33.33%',
              display: 'flex',
