...
const QuotationFilters = () => {
  ...
  const columns = [
    ...
    { id: 'SKU#', label: 'SKU#', minWidth: 110, align: "center" },
    { id: 'Job#', label: 'Job#', minWidth: 100, align: "center" },
    { id: 'Design#', label: 'Design#', minWidth: 100, align: "center" },
    { id: 'Category', label: 'Category', minWidth: 110, align: "center" },
    { id: 'Promise Date', label: 'Promise Date', minWidth: 130, align: "center" },
    { id: 'Quote Price', label: 'Quote Price', minWidth: 120, align: "center" },
    { id: 'Status', label: 'Status', minWidth: 120, align: "center" },
    { id: 'Total Qty', label: 'Total Qty', minWidth: 100, align: "center" },
    { id: 'Supplied', label: 'Supplied', minWidth: 100, align: "center" },
  ];
    ...
    data?.forEach((e, i) => {
      ...
      if (searchValue !== "") {
        if (e?.["Sr#"]?.toString()?.toLowerCase()?.includes(searchValue?.trim()?.toLowerCase()) ||
          ...
          e?.["SKU#"]?.toString()?.toLowerCase()?.includes(searchValue?.trim()?.toLowerCase()) ||
          e?.["Job#"]?.toString()?.toLowerCase()?.includes(searchValue?.trim()?.toLowerCase()) ||
          e?.["Design#"]?.toString()?.toLowerCase()?.includes(searchValue?.trim()?.toLowerCase()) ||
          ...
          e?.["Promise Date"]?.toString()?.toLowerCase()?.includes(searchValue?.trim()?.toLowerCase()) ||
          e?.["Quote Price"]?.toString()?.toLowerCase()?.includes(searchValue?.trim()?.toLowerCase()) ||
          e?.["Status"]?.toString()?.toLowerCase()?.includes(searchValue?.trim()?.toLowerCase()) ||
          e?.["Total Qty"]?.toString()?.toLowerCase()?.includes(searchValue?.trim()?.toLowerCase()) ||
          e?.["Supplied"]?.toString()?.toLowerCase()?.includes(searchValue?.trim()?.toLowerCase())) {
          flags.search = true;
        }
      } else {
        flags.search = true;
      ...
      if (e?.metal_purity?.toString()?.toLowerCase()?.includes(metalPurities?.toLowerCase()) || metalPurities === "All") {
        flags.metalPurity = true;
      }
      if (e?.metal_color?.toString()?.toLowerCase()?.includes(MetalColors?.toLowerCase()) || MetalColors === "All") {
        flags.MetalColor = true;
      }
      if (e?.Category?.toString()?.toLowerCase()?.includes(categories?.toLowerCase()) || categories === "All") {
        flags.category = true;
      }
      if (e?.Status?.toString()?.toLowerCase()?.includes(statuss?.toLowerCase()) || statuss === "All") {
        flags.status = true;
      }
